...
export default function MeshContextMenu() {
  ...
  const handleAssignExisting = (panelId: string) => {
    assignTexture(
      panelId,
      contextMenu.targetType,
      contextMenu.targetId,
      contextMenu.meshName
    );
    closeContextMenu();
  };
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-[200] glass-panel ghost-border rounded-lg soft-focus-shadow py-1 min-w-[200px]"
